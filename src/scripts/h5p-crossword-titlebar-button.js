...
export default class TitlebarButton {
  /**
   * @constructor
   *
  ...
  constructor(params, callbacks) {
    ...
    this.params = Util.extend({
      l10n: { active: '', disabled: '', inactive: '' },
      a11y: { active: '', disabled: '', inactive: '' },
      active: false,
      classes: [],
      disabled: false,
      type: 'pulse'
    ...
    // TODO: Check whether H5P.Tooltip is ready to be used to replace 'title'
  }
   ...
   */
  show() {
    this.button.classList.remove('h5p-titlebar-button-display-none');
  }
   ...
   */
  hide() {
    this.button.classList.add('h5p-titlebar-button-display-none');
  }
  ...
  enable() {
    ...
    this.button.classList.remove('h5p-titlebar-button-disabled');
   ...
   */
  disable() {
    this.button.classList.add('h5p-titlebar-button-disabled');
    this.button.setAttribute('aria-label', this.params.a11y.disabled);
    this.button.setAttribute('title', this.params.l10n.disabled);
  ...
  activate() {
    ...
    if (this.params.type === 'toggle') {
      this.button.classList.add('h5p-titlebar-button-active');
      this.button.setAttribute('aria-pressed', true);
    }

    this.button.setAttribute('aria-label', this.params.a11y.active);
    this.button.setAttribute('title', this.params.l10n.active);
  ...
  deactivate() {
    ...
    if (this.params.type === 'toggle') {
      this.button.classList.remove('h5p-titlebar-button-active');
      this.button.setAttribute('aria-pressed', false);
    }

    this.button.setAttribute('aria-label', this.params.a11y.inactive);
    this.button.setAttribute('title', this.params.l10n.inactive);
  }
